...
EFI_STATUS efi_main(EFI_HANDLE image, EFI_SYSTEM_TABLE *st) {
    ...
    UINT32 cap0 = 0, hcs1 = 0, hcc1 = 0, ext0 = 0;
    UINT64 bar;
    UINT32 xecp, ext_off;

    InitializeLib(image, st);
    Print(u"TOSHIBA xHCI V9 / FIRST EXT CAP\r\n");
    ...
    /*
     * xECP is expressed in DWORDs from the beginning of the controller
     * MMIO space. Convert to a byte offset before the read.
     */
    ext_off = xecp << 2;
