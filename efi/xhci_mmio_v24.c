...
static void done(UINT32 reads, EFI_STATUS s) {
    Print(u"\r\nV24 COMPLETE / %u MMIO READS / 2 CONTROL WRITES / NO DMA\r\n",reads);
    Print(u"RESULT: %r\r\nEXIT 5 SEC...\r\n",s);
...
EFI_STATUS efi_main(EFI_HANDLE image,EFI_SYSTEM_TABLE *st) {
    ...
    Print(u"TOSHIBA xHCI V24 / HALT THEN HOST CONTROLLER RESET\r\n");
    ...
    /*
     * V24 deliberately performs the missing transition from V23:
    ...
    if(after&CMD_RUN){
        ...
        Print(u"HALT THEN HOST CONTROLLER RESET: PASS\r\n");
