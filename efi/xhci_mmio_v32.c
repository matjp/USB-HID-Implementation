...
EFI_STATUS efi_main(EFI_HANDLE image,EFI_SYSTEM_TABLE*st)
{
 ...
 UINT16 ver=0;UINT8 port,speed,slot_type=0,slot=0;UINT32 completion=0,event_index=0,event_cycle=TRB_CYCLE,ctx_size;UINTN seg=0,bus=0,dev=0,fun=0,scratch_i;
 ...
 cr=(struct trb*)crd.host;ev=(struct trb*)erd.host;erst=(UINT64*)est.host;ep_ring=(struct trb*)ep0.host;ic=(UINT8*)inctx.host;oc=(UINT8*)outctx.host;cr[CMD_TRBS-1].d[0]=(UINT32)crd.dev;cr[CMD_TRBS-1].d[1]=(UINT32)(crd.dev>>32);cr[CMD_TRBS-1].d[3]=TRB_CYCLE|(TRB_LINK<<TRB_TYPE_SHIFT)|TRB_LINK_TOGGLE;erst[0]=erd.dev;((UINT32*)erst)[2]=EVENT_TRBS;
