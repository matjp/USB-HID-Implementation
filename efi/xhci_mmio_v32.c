...
EFI_STATUS efi_main(EFI_HANDLE image,EFI_SYSTEM_TABLE*st)
{
 ...
 s=cfg32(p,0x10,&bar0);if(EFI_ERROR(s)){fail(u"PCI",u"BAR0",s);goto out;}s=cfg32(p,0x14,&bar1);if(EFI_ERROR(s)){fail(u"PCI",u"BAR1",s);goto out;}bar64=(UINT64)(bar0&0xfffffff0U);if(((bar0>>1)&3U)==2U)bar64|=((UINT64)bar1<<32);
